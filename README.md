...
[![Version](https://img.shields.io/badge/Version-2.0.0-orange)](https://github.com)
...
| 代码工程化 | **30** | 三信号组合判定（DOM复杂度+框架检测+外部资源），2信号+20，3信号+30 |
...
规则五  代码工程化      +30 ──→                ├── YES → 红色徽章 + 桌面通知 + 警告弹窗 + 下载拦截注入
